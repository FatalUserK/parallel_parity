...
_G[init_func_name] = function(x, y, w, h)
	...
	local rel_chunk_x = ((chunk_x + half_width) % mapw) - half_width
	local rel_chunk_y = ((chunk_y + 14) % maph) - 14

	local chunk_index = rel_chunk_x .. "_" .. rel_chunk_y
